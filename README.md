...
Desarrollo herramientas, mods y mejoras para comunidades que siguen vivas muchos anos despues de su lanzamiento, sobre todo alrededor de `Freelancer` y `Homeworld`.

## En que estoy centrado

- Tooling para modding y pipelines tecnicos
- Blender y utilidades para asset workflows
- Automatizacion con `Python`, `C#` y algo de `C++`

## Tecnologias con las que trabajo

`C#` `C++` `Python` `Blender` `Laravel` `Vue.js`
...
Me atraen especialmente las herramientas pequenas pero utiles: cosas que ahorran tiempo, mejoran pipelines y hacen mas facil mantener vivos juegos clasicos y sus comunidades.
